...
static rct_widget window_options_display_widgets[] = {
	...
	{ WWT_CHECKBOX,			1,	18,		290,	174,	185,	STR_SCALE_BILINEAR,	STR_NONE },				// scaling bilinear filtering toggle

	{ WWT_GROUPBOX,			1,	5,      304,	194,	285,	STR_RENDERING_GROUP,	STR_NONE },					// Rendering group
	{ WWT_CHECKBOX,			1,	10,		290,	209,	220,	STR_TILE_SMOOTHING, 	STR_TILE_SMOOTHING_TIP },	// landscape smoothing
	{ WWT_CHECKBOX,			1,	10,		290,	224,	235,	STR_GRIDLINES,			STR_GRIDLINES_TIP },		// gridlines
	{ WWT_DROPDOWN,			1,	155,	299,	239,	249,	STR_NONE,				STR_NONE },					// construction marker
	{ WWT_DROPDOWN_BUTTON,	1,	288,	298,	240,	248,	STR_DROPDOWN_GLYPH,		STR_NONE },
	{ WWT_CHECKBOX,			1,	10,		290,	254,	265,	STR_CYCLE_DAY_NIGHT,	STR_NONE },					// cycle day-night
	{ WWT_CHECKBOX,			1,	10,		290,	269,	280,	STR_UPPER_CASE_BANNERS,	STR_NONE },					// upper case banners
	{ WIDGETS_END },
};
...
static void window_options_mouseup(rct_window *w, int widgetIndex)
{
	...
	case WINDOW_OPTIONS_PAGE_DISPLAY:
		...
		case WIDX_UPPER_CASE_BANNERS_CHECKBOX:
			...
			window_invalidate(w);
			break;
		case WIDX_SCALE_BILINEAR:
			gConfigGeneral.scale_bilinear ^= 1;
			platform_refresh_video();
			config_save_default();
			window_invalidate(w);
			break;
...
static void window_options_invalidate(rct_window *w)
{
	...
	case WINDOW_OPTIONS_PAGE_DISPLAY:
		...
		widget_set_checkbox_value(w, WIDX_SCALE_BILINEAR, gConfigGeneral.scale_bilinear);
		...
		window_options_display_widgets[WIDX_SCALE_BILINEAR].type = WWT_CHECKBOX;
		break;
